...
const Home = (props) => {
  return (
	<div className="flex flex-row h-full justify-center self-center">
	  <div className="flex flex-col w-3/5 self-center justify-center gap-y-10 px-20">
		<div className="flex flex-col self-center">
		  ...
		  <h2 className="text-4xl fade-up pb-10 font-thin">Software Engineer</h2>
		  <p className="fade-up">
	...
	<br /><br />Feel free to explore and connect — I'm always eager to discuss new ideas and opportunities!
		  </p>
		</div>
